...
<nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder"></span><span class="user-status"><?= $users->pseudo ?></span></div><span class="avatar"><img class="round" src="<?= $this->Url->build($users->avatar); ?>" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
   ...
   <div class="sidenav-overlay"></div>
    ...
    <script src="<?= $this->Url->build('/assets/vendors/js/vendors.min.js'); ?>"></script>
    <script src="<?= $this->Url->build('/assets/vendors/js/charts/apexcharts.min.js'); ?>"></script>
    <script src="<?= $this->Url->build('/assets/vendors/js/extensions/toastr.min.js'); ?>"></script>
    <script src="<?= $this->Url->build('/assets/js/core/app-menu.js'); ?>"></script>
    <script src="<?= $this->Url->build('/assets/js/core/app.js'); ?>"></script>
    <script src="<?= $this->Url->build('/assets/js/scripts/pages/dashboard-ecommerce.js'); ?>"></script>
